...
export const cardContent: ICard = {
  ...
  topRightText:
    "De tre tingene jeg virkelig liker å jobbe med er Typescript, React og design. Koding er ikke bare min jobb det er også min hobby. I tillegg spiller jeg bass og produserer musikk, og jeg kan også ta noen fine bilder",
